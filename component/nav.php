  ...
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="home.php">
        <img src="https://objectstorage.ap-sydney-1.oraclecloud.com/n/sdzsvi4t39dx/b/bucket-ardhanika/o/Brand1.png">
      </a>
    </div>
    ...
    <form action="pencarian.php" method="get" class="navbar-form navbar-right" style="margin-top: 4vh">
      <div class="input-group" style="width:45vw; margin-right: 8vw; margin-top: 1vh;">
        <input type="text" class="form-control" placeholder="Masukan kata kunci pencarian batik..." name="keyword">
