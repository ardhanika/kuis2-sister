...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="https://objectstorage.ap-sydney-1.oraclecloud.com/n/sdzsvi4t39dx/b/bucket-ardhanika/o/admin.css">
</head>
<body>
          ...
          <div class="row">
            <div class="col-xs-11 col-offset-xs-1">
                ...
                <table class="table table-hover">
                  ...
                  <tbody>
                    <?php 
                      $conn = mysqli_connect('10.0.0.30', 'ardhanika21', 'root21A.', 'batiku');
